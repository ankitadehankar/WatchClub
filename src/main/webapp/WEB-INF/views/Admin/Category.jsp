...
<center> <h2 style="color:#009688;">Manage Category</h2> </center>
<hr>
...
<div>
<table class="table Stripped" style="width:100%; text-align: center;">
 <thead>
  <tr>
 ...
 <c:forEach var="category" items="${categoryList}">
  <tr>
   ...
   <td> <a href="manage_category_edit/${category.id}" class="btn btn-default" role="button" style="color:#9e2e2e;"> Edit</a>
    |  <a href="manage_category_delete/${category.id}" class="btn btn-default" role="button" style="color:#ff0000;"> Delete</a></td>
  </tr>
